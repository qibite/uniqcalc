		...
		function creat_pult_model (pult_or_joy) {
			...
			if (pult_or_joy == 'Пульт')
			{
				...
				$.post( calc_ajaxurl.url, data_pult, function (response) {
					...
					let pult_upravleniya_TELECRANE_img = document.createElement('img'); //Картинка радио пульта
						...
						pult_upravleniya_TELECRANE.append(pult_upravleniya_TELECRANE_img);
							pult_upravleniya_TELECRANE_img.addEventListener('click', function () {
								cran._3Type = cran._2.search(/Взрыв/i) != -1 ? 'Радиоуправление с пультом Telecrane (Тайвань) ВБИ':'Радиоуправление с пультом Telecrane (Тайвань)';
							});
					...
					let pult_upravleniya_TELECRANE_price = document.createElement('span');
						...
						pult_upravleniya_TELECRANE_price.innerText = pars_summ(results.pTELECRANE);
					...
					let pult_upravleniya_IKUSI_img = document.createElement('img'); //Картинка радио пульта
						...
						pult_upravleniya_IKUSI.append(pult_upravleniya_IKUSI_img);
							pult_upravleniya_IKUSI_img.addEventListener('click', function () {
								cran._3Type = cran._2.search(/Взрыв/i) != -1 ? 'Радиоуправление с пультом Ikusi (Испания) ВБИ':'Радиоуправление с пультом Ikusi (Испания)';
							});

					let pult_upravleniya_IKUSI_price = document.createElement('span');
						pult_upravleniya_IKUSI_price.className = 'price_in_change';
						pult_upravleniya_IKUSI_price.innerText = pars_summ(results.pIKUSI);
					...
					let pult_upravleniya_HBRRadiomatic_img = document.createElement('img'); //Картинка радио пульта
						...
						pult_upravleniya_HBRRadiomatic.append(pult_upravleniya_HBRRadiomatic_img);
							pult_upravleniya_HBRRadiomatic_img.addEventListener('click', function () {
								cran._3Type = cran._2.search(/Взрыв/i) != -1 ? 'Радиоуправление с пультом HBC-Radiomatic (Германия) ВБИ':'Радиоуправление с пультом HBC-Radiomatic (Германия)';
							});
					...
					let pult_upravleniya_HBRRadiomatic_price = document.createElement('span');
						...
						pult_upravleniya_HBRRadiomatic_price.innerText = pars_summ(results.pHBC);
			...
			else
			{
				...
				$.post( calc_ajaxurl.url, data_pult, function (response) {
					...
					let pult_upravleniya_TELECRANE_price = document.createElement('span');
						pult_upravleniya_TELECRANE_price.className = 'price_in_change';
						pult_upravleniya_TELECRANE_price.innerText = pars_summ(results.jTELECRANE);
						pult_upravleniya_TELECRANE.append(pult_upravleniya_TELECRANE_price);
					...
					let pult_upravleniya_IKUSI_price = document.createElement('span');
						pult_upravleniya_IKUSI_price.className = 'price_in_change';
						pult_upravleniya_IKUSI_price.innerText = pars_summ(results.jIKUSI);
						pult_upravleniya_IKUSI.append(pult_upravleniya_IKUSI_price);
					...
					let pult_upravleniya_HBRRadiomatic_price = document.createElement('span');
						pult_upravleniya_HBRRadiomatic_price.className = 'price_in_change';
						pult_upravleniya_HBRRadiomatic_price.innerText = pars_summ(results.jHBC);
						pult_upravleniya_HBRRadiomatic.append(pult_upravleniya_HBRRadiomatic_price);
	...
	$('.dop_menu_open').on('click', '.motor_reductor_change', function(event) {
		...
		$.post( calc_ajaxurl.url, data_motor, function (response) {
			...
			let motor_reductor_9_2_price = document.createElement('span');
				...
				motor_reductor_9_2_price.innerText = pars_summ(results.p9_2);
			...
			motor_reductor.append(motor_reductor_9_3);
				...
				let motor_reductor_9_3_price = document.createElement('span');
					...
					motor_reductor_9_3_price.innerText = pars_summ(results.p9_3);
		...
		/*********************************************************************************************************************************/
			...
			motor_reductor.append(motor_reductor_9_4);
				...
				let motor_reductor_9_4_price = document.createElement('span');
					...
					motor_reductor_9_4_price.innerText = pars_summ(results.p9_4);
		...
		/*********************************************************************************************************************************/
			...
			motor_reductor.append(motor_reductor_9_5);
				...
				let motor_reductor_9_5_price = document.createElement('span');
					...
					motor_reductor_9_5_price.innerText = pars_summ(results.p9_5);
	...
	$('.dop_menu_open').on('click', '.preobrazovatel_change', function(event) {
		...
		let preobrazovatel_8_4 = document.createElement('div'); // блок пульт
			...
			let preobrazovatel_8_4_price = document.createElement('span');
				...
				preobrazovatel_8_4_price.innerText =  pars_summ(results.preo8_4);
...
/*
		let preobrazovatel_8_5 = document.createElement('div'); // блок пульт
			...
			let preobrazovatel_8_5_price = document.createElement('span');
				...
				preobrazovatel_8_5_price.innerText = pars_summ(results.preo8_5);
...
/*
		let preobrazovatel_8_6 = document.createElement('div'); // блок пульт
			...
			let preobrazovatel_8_6_price = document.createElement('span');
				...
				preobrazovatel_8_6_price.innerText = pars_summ(results.preo8_6);
...
/*
		let preobrazovatel_8_7 = document.createElement('div'); // блок пульт
			...
			let preobrazovatel_8_7_price = document.createElement('span');
				...
				preobrazovatel_8_7_price.innerText = pars_summ(results.preo8_7);
...
function get_pult_id (pult_model, type /*option*/) {
	...
	switch (pult_model) {
		case 'Пульт Telecrane':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:1, img:'3.7'}:false)
				||
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:2, img:'3.7'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:3, img:'3.7'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:4, img:'3.7'}:false)
				||
				0;
				switch (type) {
					case 'img':
		...
		case 'Пульт Ikusi':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:6, img:'3.8'}:false)
				||
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:7, img:'3.8'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:8, img:'3.8'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:9, img:'3.8'}:false)
				||
				0;
				switch (type) {
					case 'img':
		...
		case 'Пульт HBC':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:11, img:'3.9'}:false)
				||
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:12, img:'3.9'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.3') ? {id:13, img:'3.9'}:false)
				||
				(( cran._2 != 'Общепромышленное' || cran._2.search(/Пожар/i) == -1 && cran._2.search(/Взрыв/i) != -1 ) && (cran.code_of_chastotnik == '8.2' || '8.4') ? {id:14, img:'3.9'}:false)
				||
				0;
				switch (type) {
					case 'img':
		...
		case 'Joy Telecrane':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3' || '8.2' || '8.4') ? {id:5, img:'3.7a'}:false)
				||
				0;
				switch (type) {
					case 'img':
		...
		case 'Joy Ikusi':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3' || '8.2' || '8.4') ? {id:10, img:'3.8b'}:false)
				||
				0;
				switch (type) {
					case 'img':
		...
		case 'Joy HBC':
			pult_code =
				(( cran._2 == 'Общепромышленное' || cran._2.search(/Пожар/i) != -1 && cran._2.search(/Взрыв/i) == -1 ) && (cran.code_of_chastotnik == '8.3' || '8.2' || '8.4') ? {id:15, img:'3.9c'}:false)
				||
				0;
				switch (type) {
					case 'img':
...
*/
	...
	function elektro_t (el) {
		...
		if (tal.ispolnnie != 'Пожаробезопасное' && cran._2.search(/Взрыв/i) != 0 && ( cran.temper[0] != '-50' && cran.temper[1] != '+60' )) {
		...
		function bolge_t () {
			...
			tal.img = '17.5.png';
			if (tal.gp <= 2000 && tal.visota <= 12000 && (cran.temper[1] != '+60') && cran._2.search(/Взрыв/i) != 0 ) {
				try {
					document.querySelector('#std_visota').remove();
					document.querySelector('#middle_visota').remove();
				} catch(e) {
				...
				$('#kanatnaya .prt').text('От ' + pars_summ(tal.priceAJAX.bolgariya_el_canat_t));
				$('#tcepnaya .prt').text(pars_summ(tal.priceAJAX.bolgariya_el_cep_t));
			}
			else {
				tal.type = 'Канатная';
				if (cran._2.search(/Взрыв/i) == 0) {
					...
					$('#std_visota .prt').text(pars_summ(tal.priceAJAX.bolgariya_el_canatVBI_t));
					$('#middle_visota .prt').text(pars_summ(tal.priceAJAX.bolgariya_el_canatUSVVBI_t));
				}
				else {
					body_tal_element('std_visota', '17.5.1.png', 'electro_t_ch', 'Стандартная высота', 'i17_5_1', 'Left', stdv, window_tal);
					body_tal_element('middle_visota', '17.5.2.png', 'electro_t_ch', 'Уменьшенная высота', 'i17_5_2', 'Right', mdlv, window_tal);
					$('#std_visota .prt').text(pars_summ(tal.priceAJAX.bolgariya_el_canat_t));
					$('#middle_visota .prt').text(pars_summ(tal.priceAJAX.bolgariya_el_canatUSV_t));
				}
		...
		function che_t () {
			...
			if ((tal.gp <= 500 && tal.visota <= 6000) || (tal.gp <= 10000 && tal.visota <= 9000)) {
				body_tal_element('kanatnaya', '17.3.png', 'electro_t_kanat', 'Канатная', 'i17_3', 'Left', kanatnaya, window_tal)
				body_tal_element('tcepnaya', '17.4.png', 'electro_t_tcep', 'Цепная', 'i17_4', 'Right', tcepnaya, window_tal)
				$('#kanatnaya .prt').text('От ' + pars_summ(tal.priceAJAX.china_el_canat_t));
				$('#tcepnaya .prt').text(pars_summ(tal.priceAJAX.china_el_cep_t));
				easyscroll(800);
			}
			else {
				tal.type = 'Канатная';
...
function body_tal_element (main_id, image, class_img_button, zagolovok, spravka, position, func, par, prctlot, prctl) {
	let win_tal = document.createElement('div');
		...
		let win_tal_price = document.createElement('span'); // подпись под картнкой / КНОПКА
			...
			win_tal_price.innerText = prctlot ? 'От '+pars_summ(prctlot): prctl ? pars_summ(prctl):'';
