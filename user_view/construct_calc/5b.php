...
<article id="пути_для_подвесного" style="left:-4999px">
			...
			<article class="скрыть_варианты_подврельс" style="margin-top:80px">
				...
				<ul id="список_моделей_путей">
					<li>
						<img class="allimg путь_подвесной" src="{$url}images/5.13.png" alt="" style="width:220px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img class="allimg путь_подвесной" src="{$url}images/5.14.png" alt="" style="width:220px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img class="allimg путь_подвесной" src="{$url}images/5.15.png" alt="" style="width:220px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img class="allimg путь_подвесной" src="{$url}images/5.16.png" alt="" style="width:220px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
