			...
			<div class="block" style="position:relative;display:inline-block;margin:1em 0 0 3em">
				...
				<div class="hide_dop_el" style="position:absolute;width:120%;left:-74%;padding:1em">
					...
					<ul style="text-align:center">
						<li class="dopvar _33_next" style="display:inline-block"><img class="allimg" src="{$url}images/3.3.png" style="width:190px;margin:16px"><br>Подвесной пульт</li>
						<li class="dopvar _34" style="display:inline-block"><img class="allimg _34" src="{$url}images/3.4.png" style="width:190px;margin:16px"><br>Радиоуправление</li>
					</ul>
					<br><br>
					<div id="vidipultov" style="display: none;">
						...
						<hr>
						<ul style="text-align:center">
							<li class="dopvar _35" style="display:inline-block"><img class="allimg _35" src="{$url}images/3.5.png" style="width:200px;margin:10px"><br> С пульта</li>
							<li class="dopvar _36" style="display:inline-block"><img class="allimg _36" src="{$url}images/3.6.png" style="width:200px;margin:10px"><br>С джойстика</li>
						</ul>
						...
						<h2>Выберите производителя</h2><hr>
							<li style="display:inline-block"><img class="allimg _37" src="{$url}images/3.7.png" style="width:170px;margin:10px"><br> Telecrane<br>(Тайвань)</li>
							<li style="display:inline-block"><img class="allimg _38" src="{$url}images/3.8.png" style="width:170px;margin:10px"><br> Ikusi<br>(Испания)</li>
							<li style="display:inline-block"><img class="allimg _39" src="{$url}images/3.9.png" style="width:170px;margin:10px"><br> HBC - Radiomatic<br>(Германия)</li>
						</ul>
					</div>
