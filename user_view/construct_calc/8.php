...
<article id="система_управления_краном" style="left:-4999px">
			...
			<img class="allimg реле" src="{$url}images/8.1.jpg" alt="" style="width:350px"><br>
			...
			<div class="скрыть_варианты_ук" style="position:absolute;width:100%;padding:1em">
				<div class="block" style="position:relative;display:inline-block;margin:1em 1em 0 0">
					<img class="allimg одна_с" src="{$url}images/nophotos.jpg" alt="" style="width:220px"><br>
				...
				<div class="block" style="position:relative;display:inline-block;margin:1em 0 0 1em">
					<img class="allimg несколько_с" src="{$url}images/nophotos.jpg" alt="" style="width:220px"><br>
					<h4 class="несколько_с releinokontakt">Несколько скоростей движения</h4>
				</div>
			</div>

			<div class="block" style="position:relative;display:inline-block;margin:1em 1em 0 0">
			<img class="allimg преобразователь" src="{$url}images/8.2.jpg" alt="" style="width:350px"><br>
			...
			<div class="скрыть_варианты_чп" style="position:absolute;width:100%;padding:1em">
				<div class="block" style="position:relative;display:inline-block;margin:1em 1em 0 0">
					<img class="allimg esq" src="{$url}images/8.5.jpg" alt="" style="width:220px"><br>
					<h4 class="esq">ESQ (Китай)</h4>
				</div>
				<div class="block" style="position:relative;display:inline-block;margin:1em 1em 0 0">
					<img class="allimg hyundai" src="{$url}images/8.6.jpg" alt="" style="width:220px"><br>
					<h4 class="hyundai">Hyundai (Корея)</h4>
				</div>
				<div class="block" style="position:relative;display:inline-block;margin:1em 1em 0 0">
					<img class="allimg danfross" src="{$url}images/8.7.jpg" alt="" style="width:220px"><br>
