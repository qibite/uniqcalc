...
<span id="revers"><i class="fa fa-repeat" aria-hidden="true"></i></span>
	...
	<div id="first_opt" class="modal_change modal_change_hide">
		<ul class="ul_change">	
			<li id="a1" class="change_li">
				<span>
					<img src="<?=$url;?>images/puti1.png" alt="" style="width:140px">
					<p>
						<b class="hz4">Разработка проектной документации</b>
						<br>
						<span class="opisanie_parametra">10 рабочих дней</span>
					</p>
				</span>
				<span class='hiddened'>65 000 руб</span>
				<div class="container_button dopinfmain">
					<i data-info="i1_1" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
				</div>				
			</li>
			<li id="a2" class="change_li" name="rels_crane"></li>
			<li id="a3" class="change_li cat" name='tokoprovod'>
				<span>
					<img src="<?=$url;?>images/6.1.jpg" alt="" style="width:140px">
					<p>
						<b class="hz4">Токоподвод</b>
					</p>
				</span>
				<span class='hiddened'></span>
				<div id='tokoprovod1' class='change_li tokoprovod' name='tokoprovod'>
					<span>
						<img src='<?=$url;?>images/6.3.png' style='width:140px'>
						<p>
							<b class='hz4'>Кабельный с кольцами</b>
							<span class='opisanie_parametra'></span>
						</p>
					</span>
					<span class='hiddened'></span>					
					<div class="container_button dopinfmain">
						<i data-info="i10_2" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
					</div>	
				</div>
				<div id='tokoprovod2' class='change_li tokoprovod' name='tokoprovod'>
					<span>
						<img src='<?=$url;?>images/6.4.png' style='width:140px'>
						<p>
							<b class='hz4'>Кабельный с тележками</b>
							<span class='opisanie_parametra'></span>
						</p>
					</span>
					<span class='hiddened'></span>
					<div class="container_button dopinfmain">
						<i data-info="i10_3" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
					</div>
				</div>
				<div id='tokoprovod3' class='change_li tokoprovod' name='tokoprovod'>
					<span>
						<img src='<?=$url;?>images/6.5.png' style='width:140px'>
						<p>
							<b class='hz4'>Фестонный (С профиль)</b>
							<span class='opisanie_parametra'></span>
						</p>
					</span>
					<span class='hiddened'></span>
					<div class="container_button dopinfmain">
						<i data-info="i10_4" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
					</div>
				</div>
				<div id='tokoprovod4' class='change_li tokoprovod' name='tokoprovod'>
					<span>
						<img src='<?=$url;?>images/6.6.png' style='width:140px'>
						<p>
							<b class='hz4'>Открытые троллеи</b>
							<span class='opisanie_parametra'></span>
						</p>
					</span>
					<span class='hiddened'></span>
					<div class="container_button dopinfmain">
						<i data-info="i10_5" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
					</div>
				</div>
				<div id='tokoprovod5' class='change_li tokoprovod' name='tokoprovod'>
					<span>
						<img src='<?=$url;?>images/6.7.png' style='width:140px'>
						<p>
							<b class='hz4'>Закрытые троллеи</b>
							<span class='opisanie_parametra'></span>
						</p>
					</span>
					<span class='hiddened'></span>
					<div class="container_button dopinfmain">
						<i data-info="i10_6" class="fa fa-info-circle dopinf" aria-hidden="true"></i>
					</div>
				</div>
			</li>
		</ul>
	...
	<div id="second_opt" class="modal_change modal_change_hide">
		<ul class="ul_change">
			<li id="b10" class="change_li cat" name='vikluchateli'>
				<span>
					<img src="<?=$url;?>images/10.png" alt="" style="width:140px">
					<p>
						<b class="hz4">Концевые выключатели</b>
					</p>
				</span>
				<span class='hiddened'></span>
				<?php
					...
					if ($name_result) {
						...
						foreach ($name_result as $option) {
							if ($option->id != 27) {
								...
								echo "<div id='b{$id}' class='change_li' name='vikluchateli'><span><img src='{$url}images/10.{$nimg}.png' style='width:140px'><p><b class='hz4'>{$code_option}</b></p></span><span class='hiddened'>{$price} руб</span><div class='container_button dopinfmain'><i data-info='ib{$id}' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></div>";
							}
						}
					}
				?>
			</li>		
			<li id="b11" class="change_li" name="shit_electro"><span><img src="<?=$url;?>images/11.png" alt="" style="width:140px"><p><b class="hz4">Электрический щит крана</b><br><span class="opisanie_parametra">с импортными компонентами</span></p></span><span class='hiddened'></span><div class='container_button dopinfmain'><i data-info='ib11' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>
			<?php
				$variants = $wpdb->prefix . 'variants';
			...
			?>
			<li id="b12_1" class="change_li" name="sirena"><span><img src="<?=$url;?>images/12.1.png" alt="" style="width:140px"><p><b class="hz4">Световая сирена</b></span></p></span><span class='hiddened'><?=$svet_sirena?> руб</span><div class='container_button dopinfmain'><i data-info='ib12_1' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>
			<li id="b12_2" class="change_li" name="sirena"><span><img src="<?=$url;?>images/12.2.png" alt="" style="width:140px"><p><b class="hz4">Звуковая сирена</b></span></p></span><span class='hiddened'><?=$zvuk_sirena?> руб</span><div class='container_button dopinfmain'><i data-info='ib12_2' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>

			<li id="b13" class="change_li" name="stop"><span><img src="<?=$url;?>images/13.png" alt="" style="width:140px"><p><b class="hz4">Аварийный стоп</b><br><span class="opisanie_parametra">с линейным выключателем</span></p></span><span class='hiddened'></span><div class='container_button dopinfmain'><i data-info='ib13' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>
			<li id="b14" class="change_li" name="tormoz"><span><img src="<?=$url;?>images/14.png" alt="" style="width:140px"><p><b class="hz4">Тормоз на передвижение</b><br><span class="opisanie_parametra">позволяет останавливать кран</span></p></span><span class='hiddened'></span><div class='container_button dopinfmain'><i data-info='ib14' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>
			...
			<li id="b18" class="change_li"><span><img src="<?=$url;?>images/18.png" alt="" style="width:140px"><p><b class="hz4">Индивидуальная покраска</b><br><span class="opisanie_parametra">требуется согласование цвета</span></p></span><span class='hiddened'></span><div class='container_button dopinfmain'><i data-info='ib18' class='fa fa-info-circle dopinf' aria-hidden='true'></i></div></li>
		</ul>
	</div>
	<div id="third_opt" class="modal_change modal_change_hide">
		<button type="button" id="city_change" class="buttons">Изменить пункт назначения</button>
		<ul class="ul_change">
			...
			<li id="c6" class="change_li viezd" name="viezd"><span><img src="<?=$url;?>images/y6.png" alt="" style="width:140px"><p><b class="hz4">Выезд эксперта</b><br><span class="opisanie_parametra"></span></p></span><span class="hiddened"></span>
			</li>
