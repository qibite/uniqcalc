...
<span id="revers"><i class="fa fa-repeat" aria-hidden="true"></i></span>
			...
			$stoimost_provod_result = $wpdb->get_results("SELECT id, type, price FROM $stoimost_provod");
				if ($stoimost_provod_result) {
					...
					foreach ($stoimost_provod_result as $provod) {
						...
						$type = $provod->type;
						$price = $provod->price;
						echo "<div id='tokoprovod{$id}' class='change_li tokoprovod'><span><img src='{$url}images/6.{$nimg}.jpg' style='width:140px'><p><b class='hz4'>{$type}</b><span class='opisanie_parametra'>цена за метр <span style='color:#e60216;font-size:1.4em'>{$price}</span></span></p></span><span class='hiddened'></span></div>";
					}
				}
			?>
			</li>
	...
	<div id="second_opt" class="modal_change modal_change_hide">
		<ul class="ul_change">
		<li id="b3" class="change_li"><span><img src="<?=$url;?>images/_3.3.jpg" alt="" style="width:140px"><p><b class="hz4">Пульт подвесной</b><br><span class="opisanie_parametra">Входит в стоимость крана</span></p></span><span class='hiddened'>Бесплатно</span></li>
		...
		<?php
			...
			if ($name_result) {
				...
				foreach ($name_result as $option) {
					...
					$price = $option->price;
					echo "<div id='b{$id}' class='change_li'><span><img src='{$url}images/10.{$nimg}.jpg' style='width:140px'><p><b class='hz4'>{$code_option}</b></p></span><span class='hiddened'>{$price} руб</span></div>";
				}
			}
		?>
		</li>		
		<li id="b11" class="change_li"><span><img src="<?=$url;?>images/11.jpg" alt="" style="width:140px"><p><b class="hz4">Электрический щит крана</b><br><span class="opisanie_parametra">с импортными компонентами</span></p></span><span class='hiddened'></span></li>
		<li id="b12" class="change_li  cat"><span><img src="<?=$url;?>images/12.jpg" alt="" style="width:140px"><p><b class="hz4">Световая | звуковая сирена</b></p></span><span class='hiddened'></span>
		<?php
			$variants = $wpdb->prefix . 'variants';
			...
			if ($name_result) {
				...
				foreach ($name_result as $option) {
					...
					$code_option = $option->code_option;
					$price = $option->price;
					echo "<div id='b{$id}' class='change_li'><span><img src='{$url}images/12.{$nimg}.jpg' style='width:140px'><p><b class='hz4'>{$code_option}</b></p></span><span class='hiddened'>{$price} руб</span></div>";
				}
			}
		?>
		</li>
		...
		<li id="b18" class="change_li"><span><img src="<?=$url;?>images/18.jpg" alt="" style="width:140px"><p><b class="hz4">Индивидуальная покраска</b><br><span class="opisanie_parametra">требуется согласование цвета</span></p></span><span class='hiddened'></span></li>
			...
			<li id="b" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Вторая опция</p></span></li>
			<li id="c" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Третья опция</p></span></li>
			<li id="d" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Четвертая опция</p></span></li>
			<li id="e" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Пятая опция</p></span></li>
			<li id="f" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Шестая опция</p></span></li>
			<li id="g" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Первая опция</p></span></li>
			<li id="h" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Вторая опция</p></span></li>
			<li id="i" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Третья опция</p></span></li>
			<li id="" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Четвертая опция</p></span></li>
			<li id="" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Пятая опция</p></span></li>
			<li id="p" class="change_li"><span><img src="<?=$url;?>images/nophotos.jpg" alt="" style="width:140px"><p>Шестая опция</p></span></li>-->
		</ul>
	</div>
</div>