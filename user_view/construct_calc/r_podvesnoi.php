...
<article id="результат_подвесного" style="left:-4999px;width:100%">
	<div style="float:left">
		...
		<p class="ended">Базовая стоимость крана: <span id="summa_p"></span></p>		
		<p class="ended">Стоимость доплаты: <span id="doplata_p"></span></p>
		<p class="ended">Стоимость путей и токоподвода: <span id="summa1_p"></span></p>
		<p class="ended">Стоимость доп. оборудования: <span id="summa2_p"></span></p>
		<p class="ended">Стоимость услуг: <span id="summa3_p"></span></p>
		<hr>
		<p class="ended">Общая стоимость: <span id="summa4_p" style="font-weight:900"></span></p>
	</div>
		...
		<tbody class="resume_cran">
			...
			<tr>
				<td>
					...
					<i class="hover" id="cdkP">изменить</i>			
				</td>
			...
			<tr>
				<td>
					<div class="container_button">
						<span class="inform animated table_info">
							<i data-info="irejimrabotiP" class="fa fa-info-circle" aria-hidden="true"></i>
						</span>
						<i class="hover"></i>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="container_button">
						...
						<i class="hover" id="ctemperP" style="top:17px">изменить</i>
					</div>					
				</td>
				<td class="" style="vertical-align:middle">Температурный режим: <span>От </span><span id="Ptr"></span></td>
				<td class="doplataTEMPER"><span id="tminsP" style="display:block">Без доплаты</span><br><span id="tplusP" style="display:block">Без доплаты</span></td>
			</tr>
			<tr>
				<td>
					<div class="container_button">
			...
			<tr><td>
					<div class="container_button">
						<span class="inform animated table_info">
							<i data-info="isyselpitaniyaP" class="fa fa-info-circle" aria-hidden="true"></i>
						</span>
						<i class="hover"></i>
					</div>
				</td>
			...
			<tr>
				<td>
					<div class="container_button">
						<span class="inform animated table_info">
							<i data-info="irelschP" class="fa fa-info-circle" aria-hidden="true"></i>
						</span>
						<i class="hover" id="сPrelsi">изменить</i>
					</div>					
				</td>
				<td class="">Рельс: <span id="Prelsi"></span></td>
				<td class="doplata">Без доплаты</td>
			</tr>
			<tr>
				<td>
					<div class="container_button">
						<span class="inform animated table_info">
							<i data-info="idvsP" class="fa fa-info-circle" aria-hidden="true"></i>
						</span>
						<i class="hover" id="сPdvs">изменить</i>
					</div>					
				</td>
				<td class="">Параметры двигателя: <span id="Pdvs"></span></td>
				<td class="doplata">Без доплаты</td>
			</tr>
		</tbody>
	</table>
