...
<article id="пути_для_опорного" style="left:-4999px">
			...
			<article id="rels_oporniy" style="display:none;left:-18px;top:610px">
				...
				<h3>Модель кранового рельса</h3>
					<li>
						<img id="p24" class="allimg нужен_монтаж_рельс" src="{$url}images/5.5.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="p43" class="allimg нужен_монтаж_рельс" src="{$url}images/5.6.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="p50" class="allimg нужен_монтаж_рельс" src="{$url}images/5.7.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kp65" class="allimg нужен_монтаж_рельс" src="{$url}images/5.8.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kp70" class="allimg нужен_монтаж_рельс" src="{$url}images/5.9.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kp80" class="allimg нужен_монтаж_рельс" src="{$url}images/5.10.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kubik40" class="allimg нужен_монтаж_рельс" src="{$url}images/5.11.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kubik50" class="allimg нужен_монтаж_рельс" src="{$url}images/5.12.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
					...
					<li>
						<img id="kubik60" class="allimg нужен_монтаж_рельс" src="{$url}images/5.13.png" alt="" style="width:210px">
						<br>
						<div class="container_button">
							<span class="inform animated" style="margin-left:-38px;margin-right:13px">
